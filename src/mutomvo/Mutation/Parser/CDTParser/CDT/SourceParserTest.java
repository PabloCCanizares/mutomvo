 ...
 *******************************************************************************/
package mutomvo.Mutation.Parser.CDTParser.CDT;
...
import mutomvo.Mutation.Parser.CDTParser.CDT.debug.treeview.JTreeTable;
import mutomvo.Mutation.Parser.CDTParser.CDT.debug.treeview.ast.ASTTreeModel;
import mutomvo.Mutation.Parser.CDTParser.CDT.metadata.TAttribute;
import mutomvo.Mutation.Parser.CDTParser.CDT.metadata.TClass;
import mutomvo.Mutation.Parser.CDTParser.CDT.metadata.TClass.TClassType;
import mutomvo.Mutation.Parser.CDTParser.CDT.metadata.TElement;
import mutomvo.Mutation.Parser.CDTParser.CDT.metadata.TElementLocation;
import mutomvo.Mutation.Parser.CDTParser.CDT.metadata.TError;
import mutomvo.Mutation.Parser.CDTParser.CDT.metadata.TFunction;
...
public class SourceParserTest {
    ...
    protected void navigateTree(IASTNode node, int index) {
        ...
        if (node instanceof IASTBinaryExpression)
        {
            ...
            strExpression = expression.toString();
            System.out.printf(strExpression);
        }
        if (node instanceof IASTConditionalExpression)
        {
            String strExpression;
            IASTConditionalExpression expression = (IASTConditionalExpression) node;
            strExpression = expression.toString();
            System.out.printf(strExpression);
        }
