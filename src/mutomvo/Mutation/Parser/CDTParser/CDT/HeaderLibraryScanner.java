...
import mutomvo.Mutation.Parser.CDTParser.CDT.LibraryScanner;
import mutomvo.Mutation.Parser.CDTParser.CDT.utils.ExtFileFilter;
...
public class HeaderLibraryScanner extends LibraryScanner {
    ...
    @Override
    protected void configParser( SourceParserTest parser , File currentFile ) {
