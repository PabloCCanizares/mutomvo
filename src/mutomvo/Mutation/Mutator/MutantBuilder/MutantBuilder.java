...
import mutomvo.Mutation.Mutator.MutantBuilder.LogicalBuilder.LogicalBuilder;
...
public class MutantBuilder 
{
    ...
    public List<MutatedOperator> generateMutants(MutationOperator Operator) 
    {
        ...
        {
            System.out.printf("MutantBuilder::generateMutants - Null pointer catched\n");
        }
